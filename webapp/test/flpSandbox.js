		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#functionproject1functionsampleproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"functionproject1functionsampleproject1-display": {
								"semanticObject": "functionproject1functionsampleproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=functionproject1.functionsampleproject1",
									"url": sap.ui.require.toUrl("functionproject1/functionsampleproject1")
								}
							}
						}
					}
